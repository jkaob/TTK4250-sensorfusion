...
class EKF:
    ...
    def innovation_mean(
        ...
        zbar    = np.block([np.eye(2), np.zeros((2,2))]) @ x  #  predicted measurement
    ...
    def innovation_cov(self,
        ...
        S = H @ P @ np.transpose(H) + R  #  the innovation covariance
    ...
    def step(self,
        ...
        ekfstate_upd  = self.update(z,ekfstate_pred, sensor_state)  # TODO
        return ekfstate_upd
