...
class ESKF:
    ...
    def predict_nominal(
        ...
        #: Calculate predicted position and velocity (in NED)
        ...
        #: Calculate predicted acceleration, gyroscope
    ...
    def Aerr(
        ...
        A[ERR_ATT_IDX * ERR_GYRO_BIAS_IDX] = A[ERR_ATT_IDX * ERR_GYRO_BIAS_IDX] @ self.S_g
